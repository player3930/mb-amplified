...
public class OldConfiguredFeatures {
	...
	public static final RandomPatchFeatureConfig TAIGA_GRASS_CONFIG;
	    ...
	    LUSH_GRASS_CONFIG = new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(BlockStates.FERN), SimpleBlockPlacer.INSTANCE).tries(8).build();
	    ...
	    TAIGA_GRASS_CONFIG = new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(BlockStates.FERN), SimpleBlockPlacer.INSTANCE).tries(64).build();
        }
    }
    ...
    public static final ConfiguredFeature<?, ?> PATCH_GRASS_TAIGA_1 = register("patch_grass_taiga_1", Feature.RANDOM_PATCH.configure(BetaRandomPatchConfigs.TAIGA_GRASS_CONFIG).decorate(OLD_SQUARE_HEIGHTMAP).repeat(1));
